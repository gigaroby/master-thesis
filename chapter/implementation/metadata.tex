...
\centering
\includegraphics[width=0.95\textwidth]{images/system-nominal.png}
\end{figure}
...
\centering
\includegraphics[width=0.95\textwidth]{images/system-cluster-crash.png}
\end{figure}
...
\centering
\includegraphics[width=0.95\textwidth]{images/system-network-partition.png}
\end{figure}
